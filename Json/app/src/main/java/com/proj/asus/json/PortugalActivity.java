...
public class PortugalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.portugal_activity);
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(PortugalActivity.this, PortugalActivity.class);
                finishActivity();
    ...
    private void finishActivity() {
        Intent intent = new Intent(PortugalActivity.this, Activity1.class);
        startActivity(intent);
    ...
    public class FetchData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                URL url = new URL("http://livescore-api.com/api-client/scores/live.json?key=957r1BFvd03yNIm1&secret=NPqlofr2AmTS5IXfN5HOHmkUnnta6PcT&country=32");  //string converted to URL type
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            PortugalActivity.data.setText(this.dataParsed);
