...
public class UELActivity extends AppCompatActivity {
    public static TextView data;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.uel_activity);
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent = new Intent(UELActivity.this, UELActivity.class);
                finishActivity();
    ...
    private void finishActivity() {
        Intent intent = new Intent(UELActivity.this, Activity1.class);
        startActivity(intent);
    }
    ...
    public class FetchData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                URL url = new URL("http://livescore-api.com/api-client/scores/live.json?key=957r1BFvd03yNIm1&secret=NPqlofr2AmTS5IXfN5HOHmkUnnta6PcT&country=88");  //string converted to URL type
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            UELActivity.data.setText(this.dataParsed);
